...
В проекте **siem-lite** панели используют два независимых источника. См. также [`README.md`](README.md) в этом каталоге. Пустой график чаще всего означает «нет серий в **этом** источнике», а не «SIEM сломан».
